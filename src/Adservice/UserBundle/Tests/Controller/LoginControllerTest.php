...
class LoginControllerTest extends WebTestCase {
    ...
    public function testLogin() {
        ...
        $_this->assertTrue($this->client->getResponse()->isSuccessful());
        
        //comprueba que se haya devuelto una cookie de session
        $_this->assertRegExp('/(\d|[a-z])+/', $this->client->getCookieJar()->get('PHPSESSID')->getValue(),
                'La aplicación ha enviado una cookie de sesión');
        
        //link a la pagina de perfil
        $crawler = TestFunctions::linkTo($this->client, $crawler, $_this, 'table tr td a#profile');
        ...
        $crawler = TestFunctions::linkTo($this->client, $crawler, $_this, 'ol li a#home');
