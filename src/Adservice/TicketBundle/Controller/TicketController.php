...
use Adservice\TicketBundle\Entity\Archivo;
use Adservice\TicketBundle\Entity\Coche;
use Adservice\TicketBundle\Entity\Gama;
use Adservice\TicketBundle\Entity\Marca;
use Adservice\TicketBundle\Entity\Modelo;
use Adservice\TicketBundle\Entity\Sistema;
use Adservice\TicketBundle\Entity\Subsistema;
use Adservice\UsuarioBundle\Entity\Usuario;
    ...
    public function formAction() {
         ...
         if ($request->getMethod() == 'POST') {
            ...
            if ($form->isValid()) {
                    ...
                    return $this->render('TicketBundle:Ticket:form.html.twig', array());
                }
            }
            */
         $tickets = $em->getRepository('TicketBundle:Ticket')->findAll();
         
         return $this->render('TicketBundle:Ticket:form.html.twig', array( 'tickets' => $tickets));
