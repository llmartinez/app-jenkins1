        ...
        if ($request->getMethod() == 'POST') {
            ...
            // if (($car->getModel()[0] != "") && ($car->getBrand()[0] != "")) {
                ...
                if ($ticket->getSubsystem() != "" or $security->isGranted('ROLE_ASSESSOR') == 0) {
                    ...
                    } else { $this->get('session')->setFlash('error', 'T515: '.$this->get('translator')->trans('error.bad_introduction').'<br>FORM:<br>'.($form ->isValid() or $form_errors  == 'The uploaded file was too large. Please try to upload a smaller file').'<br>FORM_C:<br>'.($formC ->isValid() or $formC_errors  == 'The uploaded file was too large. Please try to upload a smaller file').'<br>FORM_D:<br>'.($formD ->isValid() or $formD_errors  == 'The uploaded file was too large. Please try to upload a smaller file')); }
