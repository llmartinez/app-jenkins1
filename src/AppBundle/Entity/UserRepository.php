...
class UserRepository extends EntityRepository
{
    ...
    public function findByOption($em, $security, $country, $catserv, $option, $term, $field, $pagination)
    {
        ...
        $query = 'SELECT u FROM AppBundle:user u JOIN u.user_role r WHERE r.name = :role';
    ...
    {
        $query = 'SELECT count(u) FROM AppBundle:user u JOIN u.user_role r WHERE r.name = :role';
