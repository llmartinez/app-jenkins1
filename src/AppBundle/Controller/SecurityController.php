...
class SecurityController extends Controller
{
    ...
    /**
     * Autologin del usuario a través de un token
    ...
    public function autologinAction(Request $request)
    {
        ...
        if($token != null)
        {
            ...
            if(isset($hash) and $hash != null and $hash != "")
            {
    			...
    			$user = $em->getRepository('AppBundle:User')->findOneByToken($hash);

                if($user != null)
                {
    				$key = new UsernamePasswordToken($user, $user->getPassword(), "main", $user->getRoles());
        ...
        ///////////////////////////////////////////////////////////////////////////////////////
            ...
            // $user = $em->getRepository('AppBundle:User')->findOneById(1003); //48 = ganixtalleres
            // $tok = $user->getToken();
            ...
            // echo "
            //     <form action='".$this->generateUrl('autologin')."' method='POST'>
            //         <input id='token' name='token' type='text' value='".$enc."'><input type='submit'>
            //     </form>";
            // die;
        ///////////////////////////////////////////////////////////////////////////////////////
    }
